...
//Ec2
# EC2 Instance Public DNS Output using Latest Generalized Splat Operator - Returns the List
output "instance_publicdns" {
  description = "EC2 Instance Public DNS"
  value       = aws_instance.bastion_ec2.public_dns
}

# EC2 Instance Public IP Output using Latest Generalized Splat Operator - Returns the List
